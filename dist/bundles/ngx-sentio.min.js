...
e&&this.chartWrapper.chart.redraw()},t.decorators=[{type:e.Directive,args:[{selector:"sentioMatrixChart"}]}],t.ctorParameters=function(){return[{type:e.ElementRef}]},t.propDecorators={model:[{type:e.Input}],duration:[{type:e.Input}],chartReady:[{type:e.Output}]},t}(),c=/** @class */function(){function t(t){
// Chart Ready event
this.chartReady=new e.EventEmitter,
// Interaction events
...
// Set up the resizer
this.resizeUtil=new h(t,this.resizeHeight||this.resizeWidth)}/**
     * For the timeline, both dimensions scale independently
     */
/** @nocollapse */
return t.prototype.setChartDimensions=function(t,e){void 0===e&&(e=!1);var r=!1;(e||this.resizeWidth)&&null!=t.width&&this.chartWrapper.chart.width()!==t.width&&(
// pin the height to the width
this.chartWrapper.chart.width(t.width),r=!0),(e||this.resizeHeight)&&null!=t.height&&this.chartWrapper.chart.height()!==t.height&&(
// pin the height to the width
this.chartWrapper.chart.height(t.height),r=!0),r&&this.chartWrapper.chart.resize()},t.prototype.onResize=function(t){this.resizeUtil.resizeObserver.next(t)},t.prototype.ngOnInit=function(){var t=this;
// Initialize the chart
this.chartWrapper.initialize(),
...
t.setChartDimensions(t.resizeUtil.getSize()),t.chartWrapper.chart.redraw()}),
// Set the initial size of the chart
this.setChartDimensions(this.resizeUtil.getSize(),!0),this.chartWrapper.chart.redraw(),
