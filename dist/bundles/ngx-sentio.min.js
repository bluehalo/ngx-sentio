...
!function(t,e){"object"==typeof exports&&"undefined"!=typeof module?e(exports,require("@angular/core"),require("@asymmetrik/sentio"),require("d3-selection"),require("rxjs"),require("rxjs/operators")):"function"==typeof define&&define.amd?define(["exports","@angular/core","@asymmetrik/sentio","d3-selection","rxjs","rxjs/operators"],e):e(t.ngxSentio={},t.ng.core,t.sentio,t.d3,t.Rx,t.operators)}(this,function(t,e,r,i,s,n){"use strict";/**
...
function t(t,e,r){this.chartElement=i.select(t.nativeElement),this.chart=e,this.chartReady=r}/**
     ...
     */
return t.prototype.initialize=function(){this.chart.init(this.chartElement),this.chartReady.emit(this.chart)},t}(),h=/** @class */function(){function t(t,e,r,a){void 0===e&&(e=!0),void 0===r&&(r=200),void 0===a&&(a=100);var h=this;this.enabled=e,this.chartElement=i.select(t.nativeElement),this.chartElement.style("display","block"),
// Create a hot observable for resize events
this.resizeSource=s.Observable.create(function(t){h.resizeObserver=t}).pipe(n.publish(),n.refCount(),n.filter(function(){return h.enabled})),null!=r&&(this.resizeSource=this.resizeSource.pipe(n.debounceTime(r))),null!=a&&(this.resizeSource=this.resizeSource.pipe(n.sample(s.interval(a)))),this.resizeSource=this.resizeSource.pipe(n.map(function(){return h.getSize()}))}/**
...
return r.style.overflow=i,{width:n,height:a}},t.prototype.getSize=function(){return{element:this.getComputedElementSize(this.chartElement.node()),parent:this.getComputedElementSize(this.chartElement.node().parentElement)}},t.prototype.destroy=function(){this.resizeObserver.complete()},t}(),o=/** @class */function(){function t(t){
// Chart Ready event
...
// Set up the resizer
this.resizeUtil=new h(t,this.resizeHeight||this.resizeWidth),this.timelineUtil=new p(this.chartWrapper)}/** @nocollapse */
...
// Auto Brush events
this.autoBrush.dispatch().on("brushChange.internalDynamicTimeline",function(e){t.setTimelineExtent(e)}),
// Emit that the charts are ready
this.chartReady.emit({timeline:this.timeline,autoBrush:this.autoBrush})},t.prototype.setTimelineExtent=function(t){this.timeline.xExtent().overrideValue(t),this.timeline.redraw()},t.decorators=[{type:e.Directive,args:[{selector:"[sentioDynamicTimeline]"}]}],t.propDecorators={timelineDirective:[{type:e.ContentChild,args:[c]}],autoBrushDirective:[{type:e.ContentChild,args:[u]}],chartReady:[{type:e.Output,args:["sentioChartReady"]}]},t}(),d=/** @class */function(){function t(t){
// Chart Ready event
this.chartReady=new e.EventEmitter,
// Create the chart
