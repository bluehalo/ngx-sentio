...
function t(t,e,r){this.chartElement=i.select(t.nativeElement),this.chart=e,this.chartReady=r}/**
     ...
     */
return t.prototype.initialize=function(){this.chart.init(this.chartElement),this.chartReady.emit(this.chart)},t}(),a=/** @class */function(){return function(t,e){this.width=t,this.height=e}}(),h=/** @class */function(){function t(t,e,r,n){void 0===e&&(e=!0),void 0===r&&(r=200),void 0===n&&(n=100);var a=this;this.enabled=e,this.chartElement=i.select(t.nativeElement),
...
return t.forRoot=function(){return{ngModule:t,providers:[]}},t.decorators=[{type:e.NgModule,args:[{exports:[g,o,p,c,d,l],declarations:[g,o,p,c,d,l]}]}],t.ctorParameters=function(){return[]},t}();t.SentioModule=y,Object.defineProperty(t,"__esModule",{value:!0})});