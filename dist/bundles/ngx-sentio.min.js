...
this.chartReady.emit({timeline:this.timeline,autoBrush:this.autoBrush})},t.prototype.setTimelineExtent=function(t){this.timeline.xExtent().overrideValue(t),this.timeline.redraw()},t.decorators=[{type:e.Directive,args:[{selector:"[sentioDynamicTimeline]"}]}],t.ctorParameters=function(){return[]},t.propDecorators={timelineDirective:[{type:e.ContentChild,args:[u]}],autoBrushDirective:[{type:e.ContentChild,args:[p]}],chartReady:[{type:e.Output,args:["sentioChartReady"]}]},t}(),l=/** @class */function(){function t(t){
// Chart Ready event
this.chartReady=new e.EventEmitter,
// Create the chart
